...
(function () {
    ...
    function loadSampleData() {
        ...
        Word.run(function (context) {
            ...
            body.insertText("This bLouis a sample text Zébulon Téophilémon inserted in Anatole the anatole document. théophilemnon is not a cool guy lololol",
    ...
    function hightlightLongestWord() {
        ...
        Word.run(function (context) {
            ...
            .then(function () {
                ...
                //for (var i = 0; i < 26; i++) {
                //    searchResults.push(range.search('A*', { matchCase: true, matchWholeWord: false, matchWildcards: true }));
                //}
